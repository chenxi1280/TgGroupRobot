...
### 群组运维
- **健康检查**：汇总验证、强制关注、反垃圾、防刷屏、定时消息和机器人权限状态
- **强制关注**：支持频道/群组绑定、提示文案、按钮和封面配置
- **夜间管控**：以夜间模式为主，支持时段限制、管理员豁免、白名单、提示文案、全员禁言和口令开关群
...
>
> 管理员主要配置入口同时支持私聊内联面板，包括主积分、邀请链接、轮播广告、定时消息、强制关注和群组健康检查。
