...
class GarageForwardService:
    ...
    async def update_setting(
        ...
        *,
        ...
        if button_template is not None:
            setting.button_template = GarageForwardService.normalize_button_template(button_template)
    ...
    def build_button_markup(buttons: list | None) -> InlineKeyboardMarkup | None:
        if not buttons:
            return None
        normalized = GarageForwardService.normalize_button_template(buttons)
        keyboard = [
