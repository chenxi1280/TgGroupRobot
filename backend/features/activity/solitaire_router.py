...
from backend.features.activity.solitaire_handler import (
...
from backend.features.activity.solitaire_handler import solitaire_create_start_callback as solitaire_create_start
