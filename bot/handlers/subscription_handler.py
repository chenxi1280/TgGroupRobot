...
from bot.handlers.renewal_handler import handle_renewal_card_input as subscription_card_message_handler
...
async def renew_callback_alias(update, context):
    from bot.handlers.renewal_handler import renew_callback
